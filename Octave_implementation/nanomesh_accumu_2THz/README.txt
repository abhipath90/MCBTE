...
Sim_param.txt lists the simulation parameters. We take N = 100000 computational particles, number of maximum scattering event = 20, the volume of domain = 2.277e-23 m^3 and the equilibrium temperature = 300 K.
