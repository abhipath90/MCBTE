This example simulates 1D quasi-ballistic heat transfer at equilibrium temperature 300K.
We choose a 3D cube of side length 100nm and apply periodic conditions in x and y directions.
Heat conduction happens in z direction by impulsively applying wall temperatures at z=0 and z =100nm to 303K and 297K respectively.
...
mat_data.txt contains material properties of Si at room temperature. It has Frequency (rad/s), Density of state (s/rad m^3), group velocity (m/s), frequency bin size (rad/s), realaxation time (s) and polarization the same order.
...
Sim_param.txt contains N=8000000, number of maximum scattering event =10 (not important here), volume of the domain =1e-21m^3 and equilibrium temperature =300K.
